...
class HomePageTableViewCell: UITableViewCell {
    ...
    func configure(with item: Item) {
        ...
        itemDescriptionLabel.text = "Description goes here" // Placeholder description
        itemImageView.image = UIImage(systemName: "photo") // Update with actual image if available
    }
